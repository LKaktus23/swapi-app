...
import de.lkaktus.services.SpeciesService;
...
public class SpeciesController {
    ...
    @GetMapping("/get")
    @Operation(summary = "Returns the species to the ID")
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "Invalid id supplied",
                    content = @Content),
            @ApiResponse(responseCode = "404", description = "there is no species for given id",
                    content = @Content),
            ...
            @ApiResponse(responseCode = "503", description = "swapi is not available",
                    content = @Content)})
    public SpeciesDTO getSpecies(@RequestParam String id){
